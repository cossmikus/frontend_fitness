...
const clientPage = () => {
  ...
  const getClientsInfoPage = () => {
    ...
    window.location.href = '/client_page/getClientsInfo';
  };

  const getTrainerInfoPage = () => {
    // Redirect to the getTrainerInfo page
    window.location.href = '/client_page/getTrainerInfo';
  };

  const addSchedulePage = () => {
    // Redirect to the addSchedule page
    window.location.href = '/client_page/addSchedule';
  };

  const getAllSchedulesPage = () => {
    // Redirect to the addSchedule page
    window.location.href = '/client_page/getAllSchedules';
  };

  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-semibold mb-4">Welcome to Clients page</h1>
